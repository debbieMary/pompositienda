...
import { useUsuariosPorFecha } from "../../hooks/useUsuariosPorFecha";
...
export default function RegistrosUsersPorFecha({ fecha_inicio, fecha_fin }) {
  console.log("desde ventas por registros diarios", fecha_inicio, fecha_fin);

  const { mutate, data, isPending: isLoading, error } = useUsuariosPorFecha();
      ...
      <ResponsiveContainer width="100%" height="80%">
        ...
        >
          ...
          <XAxis
            ...
            tickMargin={10}
          />
          <YAxis stroke="var(--pomp-plomo-xoscuro)" width={30} />
          <Tooltip
            contentStyle={{
